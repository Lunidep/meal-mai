...
export class Operation {
  ...
  action: string; // какой адрес BFF будет вызывать у Resource Server
  uri: string; // часть URL, которая отвечает за то, с каким объектом работаем (task, category и пр)
