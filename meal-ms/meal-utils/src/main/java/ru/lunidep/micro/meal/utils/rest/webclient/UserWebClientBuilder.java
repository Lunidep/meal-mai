package ru.lunidep.micro.meal.utils.rest.webclient;
...
public class UserWebClientBuilder {
    ...
    private static final String baseUrlUser = "http://localhost:8765/meal-users/user/";
    private static final String baseUrlData = "http://localhost:8765/meal-menu/data/";
